...
class ComponentesVentana(tk.Tk):
  ...
  def _crear_componentes_tabulador_1(self, tabulador):
  ...
  def _crear_componentes_tabulador_3(self,tabulador):
    ...
    boton1 = ttk.Button(tabulador, text="Mostras valor seleccionado", command=mostrar_valor)
    boton1.grid(row=0, column=1)
    
  def _crear_componentes_tabulador_4(self,tabulador):
    imagen = tk.PhotoImage(file="18-tkinter\python-logo.png")
    def mostrar_titulo():
  ...
  def _crear_componentes_tabulador_5(self,tabulador):
    ...
    boton_inicio = ttk.Button(tabulador, text="Ejecutar barra progreso", command=ejecutar_barra)
    ...
    botton_detener = ttk.Button(tabulador, text="Detener Ejecucion", command=detener)
    botton_detener.grid(row=1, column=2)
  ...
  def _crear_tabs(self):
    # Creamos un tab control, para eso usamos la clase de Notebook
    ...
    self._crear_componentes_tabulador_1(tabulador1)
    ...
    self._crear_componentes_tabulador_2(tabulador2)
    ...
    self._crear_componentes_tabulador_3(tabulador3)
    ...
    # Crear los componentes del cuarto tabulador
    self._crear_componentes_tabulador_4(tabulador4)
    ...
    self._crear_componentes_tabulador_5(tabulador5)
